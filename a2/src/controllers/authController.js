...
const login = async (req, res, next) => {
  try {
    ...
    const validateAdmin = [
      {"id":"1","fname":"Tigist","lname":"Beshy","username":"TB123","password":"TB123"}, 
      {"id":"2","fname":"Fairbanks","lname":"Magtibang","username":"FM123","password":"FM123"},
      {"id":"3","fname":"Jozel","lname":"Surro","username":"JS123","password":"JS123"},
      {"id":"4","fname":"Joanna","lname":"Apellido","username":"JA123","password":"JA123"},
    ...
    if (admin) {
      ...
      return res.json({ token }); // return token to user
    }
...
const verify = async (req, res) => {
  ...
  const jwtToken = req.headers.authorization.replace('Bearer ', ''); // Extract the JWT token from the headers
