...
export const Login = () => {
    ...
    const handleSubmitForStudent = (e) => {
        ...
        .then(res => {
            //localStorage.setItem('loggedIn', JSON.stringify(res.token));
            //Do another fetch to get user data from verify then add the token to that object
            //and send all to the 'loggedIn'
